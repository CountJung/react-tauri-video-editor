...
if (isWindows) {
  ...
  if (msvcCheck) {
    ...
    console.warn('     winget install Microsoft.VisualStudioBuildTools 로 설치 후')
    console.warn('     "Desktop development with C++" 워크로드를 선택하세요.')
  }
...
if (existsSync(settingsPath)) {
  ...
  if (isWindows) {
    ...
    console.log(
      '    Windows: %USERPROFILE%\\.cache\\react-tauri-video-editor-target\\rust-analyzer'
    )
  } else {
    console.log('  ✅ rust-analyzer 경로 확인 완료')
  }
