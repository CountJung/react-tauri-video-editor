---
name: rust-skills
description: Rust 코딩 범용 스킬. 데이터 구조 설계, trait 구현, 매크로, 모듈 구조, 소유권/라이프타임, 에러 처리, clippy/fmt 규칙. Keywords: rust, struct, enum, trait, ownership, lifetime, Result, clippy, cargo, module
---
# Rust Coding Skill
