---
applyTo: "docs/**,PROJECT_MAP.md,AGENTS.md,.github/**"
---
...
| `PROJECT_MAP.md` (루트) | 파일 역할, 레이어 구조, 라우트 맵, 커맨드 맵, 탐색 프로토콜 | 파일/폴더/라우트/command/store/주요 컴포넌트 추가·이동·삭제 |
...
1. Rust command 추가/변경 → `tauri-backend` SKILL.md + `PROJECT_MAP.md`
2. 환경변수 추가 → `PROJECT_MAP.md` 환경변수/설정 맵
3. 라우트 추가/삭제 → `PROJECT_MAP.md` 라우트 구조
